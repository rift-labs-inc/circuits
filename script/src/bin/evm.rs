...
use clap::Parser;
use rift_lib::SolidityPublicValues;
...
fn create_plonk_fixture(proof: &SP1ProofWithPublicValues, vk: &SP1VerifyingKey) {
    ...
    //let SolidityPublicValues { n, a, b } = SolidityPublicValues::abi_decode(bytes, false).unwrap();

    // Create the testing fixture so we can test things end-to-end.
    let fixture = SP1RiftProofFixture {
